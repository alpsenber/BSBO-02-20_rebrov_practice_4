...
import ru.mirea.rebrov.cryptoloader.databinding.ActivityMainBinding;
        ...
        LoaderManager.LoaderCallbacks<String>
{
    ...
    public void generateKey()
    {
        try
        {
            ...
            secrnd.setSeed("any data used as random seed".getBytes());
            KeyGenerator keygen = KeyGenerator.getInstance("AES");
            keygen.init(256, secrnd);
            this.key = new SecretKeySpec((keygen.generateKey()).getEncoded(), "AES");
        }
